...
export default function Landing({ onGetStarted }) {   // ✅ FIXED — accepts prop
  ...
  return (
    <>
      ...
      >
        <span className="text-[#1B003F] font-bold text-xl md:text-xl tracking-wide">
          Aurora
        </span>
      </motion.div>

      <div className="aurora-bg text-[#1B003F]">
        {/* HERO SECTION */}
        <section
          ref={heroRef}
        ...
        >
          <motion.h1
            ...
            className="text-6xl font-bold text-[#1B003F] mb-2"
          >
            Aurora:
          </motion.h1>
          ...
          <motion.h2
            ...
            className="text-2xl md:text-3xl font-medium text-[#4B0082] mb-8"
          >
            A Strong Voice..
          </motion.h2>
          ...
          <motion.p
            ...
            className="max-w-2xl text-lg text-[#1B003F]/80 leading-relaxed mb-4"
          >
          ...
          <motion.p
            ...
            className="max-w-2xl text-lg text-[#1B003F]/80 leading-relaxed mb-8"
          >
          ...
          <motion.button
            ...
            bg-gradient-to-r from-[#4B0082] to-[#2A004B] shadow-md hover:shadow-lg transition-all"
          >
            Get Started →
          </motion.button>
        </section>
        ...
        >
          ...
          >
            ...
            <div className="md:w-1/2 space-y-4">
              <h2 className="text-4xl md:text-5xl font-bold text-[#1B003F]">
                Break the Silence
              </h2>
              <p className="text-lg text-[#1B003F]/80 leading-relaxed">
            ...
            >
              <img
                ...
                className="w-72 md:w-96 rounded-3xl shadow-lg border border-[#4B0082]/30"
              />
            </motion.div>
          </motion.div>
        </section>
          ...
          >
            ...
            >
              <img
                ...
                className="w-80 md:w-[28rem] rounded-3xl shadow-lg border border-[#4B0082]/30"
              />
            </motion.div>
            ...
            >
              <h2 className="text-5xl md:text-6l font-extrabold text-[#4B0082] mb-6 leading-tight">
                Why Choose Aurora:
              </h2>

              <div className="space-y-6 text-[#1B003F]/85 text-xl leading-relaxed">
                <p>
                  <b className="text-[#4B0082]">Discreet and Secure:</b> Built
                  with steganography and privacy at its core, Aurora allows
                  women to seek help safely without fear of being tracked.
                </p>
                <p>
                  <b className="text-[#4B0082]">
                ...
                <p>
                  <b className="text-[#4B0082]">Legal Empowerment:</b> Instant,
        ...
        <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 py-20">
          <motion.h2
            ...
            transition={{ duration: 1 }}
            className="text-5xl md:text-6xl font-bold text-[#4B0082] mb-12"
          >
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl w-full">
            {[
              ...
              <motion.div
                ...
                className="p-8 bg-white/40 backdrop-blur-md border border-white/30 
                rounded-3xl shadow-lg text-left hover:shadow-2xl hover:-translate-y-2 
                transition-all duration-500"
              >
                <div className="text-3xl font-extrabold text-[#4B0082] mb-2">
                  {feature.id}.
                </div>
                <h3 className="text-2xl font-semibold text-[#1B003F] mb-2">
                  {feature.title}
                </h3>
                <p className="text-[#1B003F]/80 text-lg leading-relaxed">
                  {feature.desc}
                </p>
              </motion.div>
            ))}
          ...
          <motion.h3
            ...
            className="mt-24 text-4xl font-semibold text-[#4B0082]"
          >
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-6 mt-12 max-w-4xl w-full">
            {[
              ...
              <motion.div
                ...
                className="p-8 bg-white/40 backdrop-blur-md border border-white/20 
                rounded-2xl flex flex-col items-center justify-center w-72 
                shadow-md hover:shadow-xl transition-all duration-500"
              >
                <span className="text-4xl font-bold text-[#4B0082] mb-2">
                  {stat.value}
                </span>
                <p className="text-[#1B003F]/80 text-lg font-medium">
                  {stat.text}
                </p>
              </motion.div>
            ))}
